...
export const PRESET_PROFILES: FilamentProfile[] = [
  ...
  createPreset({ id: 'sun-1', profileName: 'Sunlu PLA', printerBrand: 'Bambu Lab', manufacturer: 'Sunlu', brand: 'PLA', filamentType: 'PLA', nozzleTemp: 220, bedTemp: 65, maxVolumetricSpeed: 15, fanSpeedMin: 100, fanSpeedMax: 100, density: 1.24, notes: "Official Bambu Studio Profile" }),
  createPreset({ id: 'sun-2', profileName: 'Sunlu PETG', printerBrand: 'Bambu Lab', manufacturer: 'Sunlu', brand: 'PETG', filamentType: 'PETG', nozzleTemp: 255, bedTemp: 70, maxVolumetricSpeed: 13, fanSpeedMin: 40, fanSpeedMax: 90, density: 1.27, notes: "Official Bambu Studio Profile" }),
  createPreset({ id: 'sun-3', profileName: 'Sunlu ABS', printerBrand: 'Bambu Lab', manufacturer: 'Sunlu', brand: 'ABS', filamentType: 'ABS', nozzleTemp: 260, bedTemp: 90, maxVolumetricSpeed: 15, fanSpeedMin: 0, fanSpeedMax: 40, density: 1.04, notes: "Official Bambu Studio Profile" }),
  createPreset({ id: 'sun-4', profileName: 'Sunlu PLA+', printerBrand: 'Bambu Lab', manufacturer: 'Sunlu', brand: 'PLA+', filamentType: 'PLA', nozzleTemp: 220, bedTemp: 65, maxVolumetricSpeed: 15, fanSpeedMin: 100, fanSpeedMax: 100, density: 1.24, notes: "Official Bambu Studio Profile" }),
  ...
  createPreset({ id: 'sun-8', profileName: 'Sunlu TPU', printerBrand: 'Bambu Lab', manufacturer: 'Sunlu', brand: 'TPU', filamentType: 'TPU', nozzleTemp: 230, bedTemp: 50, maxVolumetricSpeed: 3.2, fanSpeedMin: 100, fanSpeedMax: 100, density: 1.21, notes: "Official Bambu Studio Profile" }),
  createPreset({ id: 'sun-9', profileName: 'Sunlu ASA', printerBrand: 'Bambu Lab', manufacturer: 'Sunlu', brand: 'ASA', filamentType: 'ASA', nozzleTemp: 260, bedTemp: 90, maxVolumetricSpeed: 14, fanSpeedMin: 0, fanSpeedMax: 20, density: 1.07, notes: "Official Bambu Studio Profile" }),
