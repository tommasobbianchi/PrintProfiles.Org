...
export const PRESET_PROFILES: FilamentProfile[] = [
  ...
  createPreset({ id: 'sun-4-new', profileName: 'Sunlu PLA+ 2.0 (High Speed)', printerBrand: 'Bambu Lab', manufacturer: 'Sunlu', brand: 'PLA+ 2.0', filamentType: 'PLA', nozzleTemp: 220, bedTemp: 65, maxVolumetricSpeed: 20, fanSpeedMin: 100, fanSpeedMax: 100, density: 1.24, notes: "Official Bambu Studio Profile" }),
  createPreset({ id: 'sun-5', profileName: 'Sunlu PLA Meta', printerBrand: 'Bambu Lab', manufacturer: 'Sunlu', brand: 'Meta', filamentType: 'PLA', nozzleTemp: 200, bedTemp: 55, maxVolumetricSpeed: 18, fanSpeedMin: 100, fanSpeedMax: 100, density: 1.24, notes: "High flow, low temp, high impact." }),
  createPreset({ id: 'sun-6', profileName: 'Sunlu Silk PLA', printerBrand: 'Bambu Lab', manufacturer: 'Sunlu', brand: 'Silk', filamentType: 'PLA', nozzleTemp: 220, bedTemp: 65, maxVolumetricSpeed: 12, fanSpeedMin: 100, fanSpeedMax: 100, density: 1.24, notes: "Shiny finish." }),
  createPreset({ id: 'sun-7', profileName: 'Sunlu Matte PLA', printerBrand: 'Bambu Lab', manufacturer: 'Sunlu', brand: 'Matte', filamentType: 'PLA', nozzleTemp: 220, bedTemp: 65, maxVolumetricSpeed: 15, fanSpeedMin: 100, fanSpeedMax: 100, density: 1.28, notes: "Matte surface." }),
