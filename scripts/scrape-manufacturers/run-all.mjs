...
const ALL_PARSERS = ['prusament', 'fiberlogy', 'extrudr', 'fillamentum', 'eryone', 'shopify', 'woocommerce', 'generic', 'spoolmandb', 'slicerprofiles', 'bambuprofiles', 'prusaprofiles', 'fdmmaterials', 'qidiprofiles', 'anycubicprofiles'];
