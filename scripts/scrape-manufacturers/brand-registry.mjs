...
export const BRANDS = [
  ...
  { manufacturer: 'Cookiecad', host: 'cookiecad.com', hosts: ['cookiecad.com'], platform: 'shopify' },
  ...
  { manufacturer: 'R3D', host: 'r3d.store', hosts: ['r3d.store'], platform: 'shopify' },
  ...
  { manufacturer: 'Das Filament', host: 'dasfilament.de', hosts: ['dasfilament.de'], platform: 'woocommerce' },
  ...
  { manufacturer: 'IC3D', host: 'ic3dprinters.com', hosts: ['ic3dprinters.com'], platform: 'woocommerce' },
